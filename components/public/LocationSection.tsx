...
export function LocationSection() {
  const whatsappLink = WHATSAPP_NUMBER
    ? `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Olá! Gostaria de fazer uma reserva.')}`
    : '#';
    ...
    <section id="localizacao" className="py-20 px-6">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#4A4A50]/70">
                    Vitória – ES
                    <br />
                    <span className="text-[#C4B5A3] italic text-xs">Endereço completo em breve</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#4A4A50]/70">
                    <span className="text-[#C4B5A3] italic text-xs">Horários em breve</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-[#C4B5A3]/20">
                {WHATSAPP_NUMBER && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-green-600 text-white text-sm font-semibold hover:bg-green-700 transition-all"
                  >
          ...
          {/* Map placeholder */}
          <div className="bg-white/50 backdrop-blur-md rounded-3xl overflow-hidden shadow-sm min-h-[300px] flex items-center justify-center">
            <div className="text-center p-8">
              <MapPin className="w-12 h-12 text-[#C4B5A3] mx-auto mb-4" />
              <p className="text-sm text-[#4A4A50]/50 font-[family-name:var(--font-cormorant)] italic text-lg">
                Mapa em breve
              </p>
            </div>
          </div>
