...
import { disconnect, loadInstance } from '@/lib/integrations/evolution-api';
...
/** POST /api/integrations/evolution/disconnect — logout da sessão no Evolution. */
export async function POST(req: Request) {
  ...
  try {
    ...
    return json({ error: e instanceof Error ? e.message : 'disconnect failed' }, 502);
  }
}
