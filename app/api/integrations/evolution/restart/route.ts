...
import { loadInstance, restart } from '@/lib/integrations/evolution-api';
...
/** POST /api/integrations/evolution/restart — reinicia a instância sem destruir sessão. */
export async function POST(req: Request) {
  ...
  try {
    ...
    return json({ error: e instanceof Error ? e.message : 'restart failed' }, 502);
  }
}
